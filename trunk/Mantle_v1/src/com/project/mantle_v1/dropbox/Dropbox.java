...
public class Dropbox extends Activity {
	...
	/*
	 * per rendere univoci i nomi delle chiavi passate è consigliato (la doc
	 * dice 'must') aggiungere il nome del package davanti al nome della
	 * variabile usando putExtra()
	 */
	...
	/*
	 * Procedura per scaricare un file dalla propria cartella su Dropbox o dalla
	 * cartella di un amico se si tratta di un file che ci è stato condiviso
	 */
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case DOWNLOAD_REQUEST_CODE:
			...
			if (filePath != null) {
				...
				Downloader down = new Downloader(this, mApi, filePath,
						savingPath, size);
				down.execute();
			}
			break;
	...
	private void setLoggedIn(boolean loggedIn) {
		...
		if (loggedIn) {
			...
			/*
			 * Account account; try { account = mApi.accountInfo();
			 * welcome.setText("Benvenuto" + account.displayName); } catch
			 * (DropboxException e) {
			 * welcome.setText("Nessun account ha effettuato l'accesso");
