...
public class Home extends Activity {
	...
	private final String HOME_DIR = Environment.getExternalStorageDirectory()
			.getAbsoluteFile() + "/Mantle";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * ReaderTask ha il compito di andare a leggere le mail per andare a
		 * capire se vi sono notifiche relative all'applicazione
		 */
